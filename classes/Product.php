...
class ProductCore extends ObjectModel implements InitializationCallback
{
    ...
    public static $definition = [
        ...
        'fields'         => [
            ...
            'redirect_target'           => ['type' => self::TYPE_STRING, 'shop' => true, 'validate' => 'isString', 'values' => ['product', 'category', 'home', 'category_default'], 'dbDefault' => 'product'],
    ...
    public static function processTableSchema($table)
    {
        ...
        if ($table->getNameWithoutPrefix() === 'product_shop') {
            $table->reorderColumns([
                ...
                'customizable', 'uploadable_files', 'text_fields', 'active', 'redirect_type', 'redirect_target', 'id_product_redirected', 'id_category_redirected',
