...
class ProductCore extends ObjectModel implements InitializationCallback
{
    ...
    /**
     * Target of redirection when product is disabled
     * Possible values: product, category, home, default
     *
     * @var string
     */
    ...
    /**
     * @var int Category ID to redirect to when redirect_target is 'category'
     */
    ...
    public static $definition = [
        ...
        'fields'         => [
            ...
            'redirect_target'           => ['type' => self::TYPE_STRING, 'shop' => true, 'validate' => 'isString', 'values' => ['product', 'category', 'home', 'default'], 'dbDefault' => 'product'],
    ...
    public static function processTableSchema($table)
    {
        ...
        if ($table->getNameWithoutPrefix() === 'product_shop') {
            $table->reorderColumns([
                ...
                'redirect_target', 'id_category_redirected',
