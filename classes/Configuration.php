...
class ConfigurationCore extends ObjectModel
{
    ...
    const PASSWD_TIME_BACK = 'TB_PASSWD_TIME_BACK';
    const PASSWD_TIME_FRONT = 'TB_PASSWD_TIME_FRONT';
    const PASSWD_RESET_TOKEN_LIFETIME = 'TB_PASSWD_RESET_TOKEN_LIFETIME';
    const PASSWD_RESET_TOKEN_GUEST_LIFETIME = 'TB_PASSWD_RESET_TOKEN_GUEST_LIFETIME';
    const PASSWD_RESET_TOKEN_ON_LOGIN = 'TB_PASSWD_RESET_TOKEN_ON_LOGIN';
    const PASSWD_RESET_REQUEST_LIMIT = 'TB_PASSWD_RESET_REQUEST_LIMIT';
