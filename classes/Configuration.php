...
class ConfigurationCore extends ObjectModel
{
    ...
    const PASSWD_RESET_TOKEN_LIFETIME = 'PS_PASSWD_RESET_TOKEN_LIFETIME';
    const PASSWD_RESET_TOKEN_GUEST_LIFETIME = 'PS_PASSWD_RESET_TOKEN_GUEST_LIFETIME';
    const PASSWD_RESET_TOKEN_ON_LOGIN = 'PS_PASSWD_RESET_TOKEN_ON_LOGIN';
    const PASSWD_RESET_REQUEST_LIMIT = 'PS_PASSWD_RESET_REQUEST_LIMIT';
