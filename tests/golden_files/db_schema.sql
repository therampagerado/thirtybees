...
CREATE TABLE `PREFIX_product` (
  ...
  `redirect_target` enum('product','category','category_default','home') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'product',
  `id_category_redirected` int(11) unsigned NOT NULL DEFAULT '0',
