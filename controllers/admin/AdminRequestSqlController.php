...
class AdminRequestSqlControllerCore extends AdminController
{
    ...
    public function renderList()
    {
		...
		<ul>
			...
			<li>'.$this->l('You can then view the query results by clicking on the query in the list view or the View action in the dropdown menu: ').' <i class="icon-search-plus"></i></li>
